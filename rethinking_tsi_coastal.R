...
# 1. Setup
################################################################################
pkgs <- c("devtools", "randomForest", "dplyr", "arm", "xtable","caret",
          "ggplot2","knitr", "here", "readxl", "rjags")
...
# #load coastal data
# coastalData<-read.csv(here("bm/CoastalWQ_20161129.csv"))
# 
# #betty's rf code
...
# dim(coast2010) #740 21
# dim(coast2010.cc) #732 21
# 
# 
# x<-complete.cases(coast2010.cc[,predVar])
# coast2010.cc<-coast2010.cc[x,]
# dim(coast2010.cc) #570 21
# 
# 
...
# save(coast2010, coast2010.cc, coastalData, coast2010.rf, file=here("bm/coast2010rf.rda"))
load(here("bm/coast2010rf.rda"))


varImpPlot(coast2010.rf,type = 1)

#variables to use
keep<-c('TN', 'secchi', 'DIN', 'TP', 'SUBREGIONS', 'DIP')
